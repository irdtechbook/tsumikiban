...
@<b>{そういえばPICって出てきていきなりめちゃくちゃ流行りましたよね}
...
先の例で挙げたようにマイコンでリレーを制御し、モーターをオン/オフする回路を作ったとしましょう。ここに出てくる要素だけで、マイコン、制御プログラム、配線、リレー、負荷、電源、といったふうに急に登場人物が増えましたね。この全員が正しく(想定したとおりに)動く必要があります。どれかひとつでも間違っていれば想定の動作はしません。順番に確認できればよいですが、確認しやすい部分、確認しづらい部分があります。どうやって確認するのかを考える必要もあります。テスタで当たってわかる場合、動作音や光でわかる場合、プログラムのように画面でチェックする場合もあるでしょう。場合によっては素子を触って熱いと感じて、異常に発熱していることから何か異常があることに気づくケースすらあります。配線などは「目視」でチェックしますが、はんだ不良のように、テスタや顕微鏡でチェックする場合もあります。最後、けっきょくは素子が壊れていたなんてこともありえます。
...
システムとして作り上げるためには、センサ、表示器、リレーなど、負荷（モーター、アクチュエータなど）、通信やネットワークという風に構成要素はどんどん増えていきます。そして、失敗する確率は文字通り「加速度的に」増加していきます。ミスが1か所ならまだよいですが、2つ以上のミスが同時に発生すると、解析の難しさは飛躍的にUpします。

　

//noindent
@<b>{要素が増えた時の切り札　モジュール化}
...
センサがセンシングできる内容は、物理量の変化や状態の変化ですが、人が知覚できること、あるいは人には知覚できないことがあります。いずれにせよ、何らかの情報をマイコンに教える手段であると考えてください。であれば、操作したことを教えるという意味で単純なスイッチですらセンサといっていいかもしれません。また通信によって情報が届くことも、この文脈ではセンサといっていいかもしれません。
