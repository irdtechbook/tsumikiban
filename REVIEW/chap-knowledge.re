...
電子工作で軽く遊ぶ分には付け、焼き刃やちょい足し情報でも構わないケースも多いのですが、もう少し本格的にやりたくなったときに何をやればいいのかわからない、体系的にもう少し掘ってみたい……という方もおられるかもしれません。そういった方に向けての参考情報も記載していきますね。


電子回路設計、実装に関する分野を体系的に学ぶために、色々と方法はあるのですが、筆者的にオススメなのは資格試験の受験対策書籍です（もちろん、受験しても更にいいですね！　ただこの本の本筋からは外れちゃいますのであまり詳しくは書きません。笑）。色々と筆者が取得したものを中心に書いておきますので、参考にしてくださいね。
...
これについては、色んな出版社様からアマチュア無線技士国家試験の試験対策書籍が出ています。なお、ＣＱ出版社さんのが一番鉄板ですね（アマチュア無線の専門雑誌を出してる出版社さんなので）。こちらの試験対策書籍はちゃんと試験対策になるよう、ある程度しっかりした内容が展開され、結構歯ごたえもあります。ちゃんと学びたいならこっちもアリですね。
...
なお、電気主任技術者試験も知識としては類似する部分もありますが、こちらはペーパーテストのみだったり、管理側、あるいは計算が多かったりで、電子工作の先にある資格としては電気工事士をお勧めします。
