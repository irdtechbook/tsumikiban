...
//flushright{
ふーれむ@ditflame,おやかた@oyakata2438
//}
...
電池のサイズとしては単1から単5まで形状が一般的であり、一応国内に流通している電池には、正式な規格ではないものの、単6電池という形状もあります。
...
電池の写真もせっかくなので見てみましょう。上がボタン電池ですね。リチウム電池と@<strong>{アルカリボタ「ソ」電池}です。


@<strong>{アルカリボタ「ソ」電池}という表記は買ってから気づいたのですが、大阪のでんでんタウン（電気街）にて入手、10個170円でした。安定の中華製です。一応問題なく使えています。
...
//image[battery2][筆者の家にあった電池の例 2]

　

//noindent
@<b>{コラム：俺のミニ四駆が２割遅い件（アルカリ電池用充電器について）}

　

じつはアルカリ乾電池は充電できないと一般的に言われており、各種教科書などにもそう記載されているのですが、世の中には@<strong>{アルカリ乾電池の充電器}なるものが存在します。
...
また、アルカリ電池の充電器は普通の二次電池の充電器とは少し回路構成が異なるそうで、@<strong>{普通のニッケル水素やニッケルカドミウム電池用の充電器では、絶対に充電を行ってはいけません。}


さて、アルカリ電池を充電できると、経済性の観点で単純に嬉しい…ような気もするのですが、「液漏れの危険性が無視できない」電池って、実際のところどこに使うのが一番妥当なんでしょう？


個人的にヒントになるだろうなと思っているのは「電池を入れて@<strong>{ほったらかしで利用しない}」電気製品です。
...
一次電池との大きな違いは充電ができること。原理や挙動は以下の通りです。
...
したがって、厳密にいうと「充電しようとしてもメモリ効果が顕著に起きてすぐ充電できなくなるのが一次電池」ということになるようです。
...
参考：ニッケル・カドミウム電池@<fn>{nicd}@Wikipedia

//footnote[nicd][@<href>{https://ja.wikipedia.org/wiki/ニッケル・カドミウム蓄電池, https://ja.wikipedia.org/wiki/ニッケル・カドミウム蓄電池}]
...
参考：ニッケル・水素電池@<fn>{nimh}@Wikipedia

//footnote[nimh][@<href>{https://ja.wikipedia.org/wiki/ニッケル・水素充電池, https://ja.wikipedia.org/wiki/ニッケル・水素充電池}]
...
1セルあたり2Vの電圧が出せます。車だと6セルあって12V（大型車だと電池ユニットをふたつつけて24Vになっているものもありますね）。
...
重量エネルギー密度という指標があり、単位はWh/㎏です。簡単には、1㎏のバッテリーからどれくらいのエネルギーが取り出せるかという指標で、鉛電池は30～40Wh/㎏です。ちなみに、ノートパソコンのバッテリーに多用されているリチウムイオン電池は100～240Wh/kgに及びます。ということは、3倍～8倍程度の差がありますね。たとえば50Whのバッテリーを積んだパソコンがあるとして、リチウムイオン電池ならざっくり200g～がバッテリーの重量と計算できますが、鉛電池で実現しようと思ったら1.5kgくらいバッテリーを載せる必要があるということになります。そんなノートパソコン持ち歩きたくないですね。ただし、エネルギー密度が低いということは、自然発火などしにくいので、その分安全ということでもあります。

バッテリーの重量がクリティカルな用途では、こういった観点も考慮が必要な項目です。

参考：鉛蓄電池@<fn>{namari}＠Wikipedia

//footnote[namari][@<href>{https://ja.wikipedia.org/wiki/鉛蓄電池, https://ja.wikipedia.org/wiki/鉛蓄電池}]
...
//image[li-box][リチウム入ってる]


参考：リチウムイオン電池@<fn>{li-ion}@Wikipedia

//footnote[li-ion][@<href>{https://ja.wikipedia.org/wiki/リチウムイオン二次電池, https://ja.wikipedia.org/wiki/リチウムイオン二次電池}]
...
当然、液体ないし不織布なので、構造上あまり強いものではなく、＋電極と－電極が何らかの理由で短絡(ショート)してしまうと起電力が発生しなくなったり（実際に車載バッテリーだとバッテリーセル単位で発生することが知られています）、逆にエネルギーが蓄えられた状態で金属の針などで貫通してしまうと、発火する危険性もあります。


全固体電池というのは、この電解質の部分を固体にすることで、@<strong>{バッテリーセルを強固なひとつの固体とする事ができる}のが最大のメリットであろうと考えられます（電気自動車などのバッテリーセルを考えても、当然ながら自動車としての運用に耐えられるバッテリーセルにしようとすると構造を補強する必要があるのに対し、全固体電池になるとその補強が少なくて済むので、車重が軽くなるだろう、というのは普通にありそうなシナリオですね）。
他にも電解質であると当然それは液体なので、水分が揮発したりガスとして放出されたりといった劣化しやすい特性があるのですが、全固体になるとそれも固体なので大分低減されると考えられます。


全固体電池の開発にはレアメタルが必要であることが昨今ネックとなっていたようですが、最近日本のとある企業が世界で初めてレアメタルを必要としない（ナトリウムでそれを実現した）全固体電池の開発に成功@<fn>{ナトリウムイオン全固体電池}したようですね。

//footnote[ナトリウムイオン全固体電池][@<href>{https://www.neg.co.jp/news/20211118-5221.html, https://www.neg.co.jp/news/20211118-5221.html}]
...
太陽のエネルギーで半導体に電子の運動を起こしつつ一方向に流すと、あら不思議！@<strong>{電気が発生しますね}的なやつです。
...
また、原子力電池というものがあり、核物質と、核物質の自然崩壊によるベータ線等に反応する蛍光物質、その光を電気に変える太陽電池の組み合わせで発電するものです。完全密封、可動部なし、発熱なしで電源として使えるという面白い特徴があります。

太陽の光がほとんど届かないような深宇宙探索用の探査機などの電源として使われることがあるようです。
...
ここでの代表的なアプローチは@<strong>{AC(交流)電源からDC(直流)電源を作る}ということになるでしょう。
...
15番と16番を短絡すると12Vと5Vが事実上取り放題！やったね！　定格400Wの電源からは、12Vが30A程度、5Vが15A程度取れます。400W電源というと、ゲーミンググラボをつなぐには少し心もとない気もしますが、電子工作用には十二分のおつりが来ます。
...
基本的な安定化電源というのは、原理については実は結構単純でして、保護回路などを除けば３ステップ（@<strong>{変圧}、@<strong>{整流}、@<strong>{平滑化}）で完結します（実はほぼ中学物理レベルです）。
...
//image[ps01][安定化電源１ 降圧トランスによる電圧電流の変換]


ちなみに、トランスによる電圧変換は巻数の比になります。たとえば単純な例ですが、5:1の巻数比だとAC100V入力からAC20V出力が取れます(流せる電流は巻線の太さなどによります)。


//image[ps01_1][安定化電源１ 降圧トランスによる電圧電流の変換(変換前波形)]


//image[ps01_2][安定化電源１ 降圧トランスによる電圧電流の変換(変換後波形:電圧が下がっている)]
...
//image[ps02][安定化電源２ ダイオードによる交流から脈流への変換]


交流をブリッジダイオードを用いて脈流に変えましょう。


※なお、ブリッジダイオード（ダイオード4石）ではなく、ダイオード1石を用いた半波整流回路というもう少し簡単な回路もあるのですが、「ダイオードのコストが下がる」以外のメリットが薄い回路構成になってしまうため、本記事では省略しています。


//image[ps02_1][安定化電源２ ダイオードによる交流から脈流への変換(変換前波形:交流)]


//image[ps02_2][安定化電源２ ダイオードによる交流から脈流への変換(変換後波形:脈流)]


ちなみに、脈流というのは図のように、交流の0からマイナスに本来向かうところをプラスになるよう（今回は割愛していますが、半波整流回路では「流れないように」します）ダイオードで波形を整え、一方向にのみ電流を流すような波形を言います。

=== 平滑化回路について


//image[ps03][安定化電源３ 大容量コンデンサ、三端子レギュレータなどによる電圧の平滑化]


脈流をならしましょう。ならしたあとのイメージが脈流の上からかぶせるように太線で描いたものが電圧の例示となります。なお、この回路のグラフについてはコンデンサのキャパシタンスに大いに左右される面もあるため、概要のみ示しています。


//image[ps03_1][安定化電源３ 大容量コンデンサによる平滑化イメージ]


電圧差が1.4V以上ある場合は三端子レギュレータなどで波打ってる部分を削って、更なる平滑化も検討しましょう。ちなみに三端子レギュレータを挟まないと、交流に起因するノイズが必ず出ます。ダイオードをひとつだけ使った半波整流回路を通した場合はACの周波数のノイズ、ブリッジダイオードを使った全波整流回路を通した場合はACの周波数の倍の周波数のノイズが出ます。
...
参考：TDKさんの参考記事@<fn>{tdkさんの参考記事}

//footnote[tdkさんの参考記事][@<href>{https://www.tdk.com/ja/tech-mag/power/002, https://www.tdk.com/ja/tech-mag/power/002}]

前述の安定化電源だと周波数が50Hz/60Hzのため、周波数が低く、鉄心トランスを用いる必要があったのですが、スイッチング電源では、スイッチング回路(高速な電源のOn/OFF動作をスイッチングと呼びます)により周波数が跳ね上がるため、小型・軽量なセラミックコアを用いたトランスを用いる事が一般的です。詳しく知りたい方は専門書を参考にしてください（たぶんCQ出版社などで参考書が大量にあるはずなので）。

一般にスイッチング電源では安定化電源に比べ素子を小型化することができます。従来大きなトランスを用いていた変圧も、小型のフェライトコアを用いることができるようになったりしますし、平滑コンデンサも周波数が高いので貯めないといけない電力量が低減され、小さいコンデンサで済むようになります。これらの理由から、大幅に小型・軽量な電源となっています。


三端子レギュレーターは、電力の一部を熱として捨てることで安定化していましたが、スイッチング電源では電力を「切り貼りして」安定化しています。その結果、各段に高効率になっています。また、三端子レギュレーターなどではできなかった「昇圧」も可能です。
