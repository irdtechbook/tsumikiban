...
ソフトウェア開発でも類似の状況になることは多いでしょう。特定の言語（たとえばアセンブラ）でカリカリにチューニングして書かなければいけないようなシチュエーションも世の中にはありますが、たいていの場合は、言語そのものの選定より、アルゴリズムの選定が重要な場合が多いといったことを想定してください。もちろんクリティカルなミッションである場合もあるでしょう。ですが、特定部分以外は形になっている状態を作り上げることで、システム全体として問題ないのか、改善すべきところはどこか、といった観点で再設計、改善仕様提案が可能となります。手元にあるデバイスで一度作ってみましょう。必要十分かもしれません。足りないところがあれば、そこについて対応を取りましょう。
...
小さい目標にブレイクダウンすることで、様々なメリットが生まれます。小さい目標は、タスクといいかえることができます。
...
目標サイズは任意で決めて構いませんが、最大でも1日の作業のサイズとしましょう。あるいは2時間程度の作業量が適当かもしれません。趣味開発ですから本業の傍ら、たとえば夜や休日の昼間にやる内容でしょうから、集中して2時間程度というのが根拠になります。2時間だと大したことができない？という向きもあるかもしれませんが、ポモドーロテクニック@<fn>{pomodoro}を使うと、(25分+5分)×4の作業量になりますから、集中すればかなりの作業量になります。また、予想外に時間がかかってしまったとしても、それだって立派なふりかえりです。次に持ち越しましょう。

//footnote[pomodoro][ポモドーロテクニック：25分の作業と5分程度の短い休憩で分割し、この1セットを1ポモドーロとし、4ポモドーロで長めの休憩を取るという手順で行う時間管理術。また、ひとつのタスクを1ポモドーロで完結するように設定する、割り込みがあったら中断し新たに1ポモドーロを設定する、などありますが、集中して進捗を出すことができるテクニックです。]


目標が大きすぎると、あるいは最終的に完了したときのみ振り返りを行うような状況を考えてみてください。全体的に苦労したけど楽しかった、といったもやっとした感想になってしまいませんか？楽しいことはよいことですが、前述のような粒度の細かい振り返りは難しいと考えざるをえません。
...
このとき、明確な締切を作ることができれば、所要時間と進捗をきちんと定義することができます。特に開発ステップを細かいタスクに分割することができればもう勝利は目前です。
...
コンテストやイベントは、開催日やエントリー期限などの「外的な」締切が設定されます。しかも、たいていはエントリー期限と提出期限、あるいは本番（イベント日）というふうに、締め切りが多段に設定されます。エントリーの段階では多少見切りで発進・エントリーしてしまっても、本番や提出日といった最終期限までに何とかするという強いモチベーションになります。モチベーションこそが進捗の源泉です。


また、最終目標までは到達しなくても、最低限の動きを実装したりまではできることがあるでしょう。これはちょっと見方を変えると、MVPといえるかもしれません。


そして、イベントなどでフィードバックをもらい、明日からの進捗の糧としましょう。イベントに出ると、様々な人がほめてくれます。質問もたくさんくるでしょう。実装のヒント、改善のヒントがもらえるかもしれません。またコミュニティ、界隈との繋がりのきっかけになることもあるでしょう。

== ソフト開発の手法を取り入れる


ソフトウェア開発の分野では、アジャイル開発といわれる開発手法が近年メジャーになっています。ここまで述べたいくつかのトピックスは、アジャイル開発の中でいわれる内容を取り入れたものです。アジャイル開発自体非常に幅広くかつ深遠なテーマですから、すべてを書きることはできません。筆者の知っている範囲は非常に狭いので、そういう手法を取り入れるといいですよ、という小さなフックを作るにすぎません。ですが、これまで何回か挫折した方、積み基板を作ってきた方は、電子工作の入門書を新しく買うのではなく、アジャイル開発に関する書籍を一度読んでみるなどしてみてはどうでしょう？一部取り入れるだけでも大幅に進捗が出るかもしれません。
...
トライアンドエラーになりがちな電子工作ですが、物理面もバージョン管理ができたらいいのに…とは思いつつ、まずはソフト・コードだけでも管理できるようになるとよいですね。普段からGitを使っている人はそのまま使ってみましょう。初めての人は、「わかばちゃんと学ぶGit使い方入門」@<fn>{wakabagit}などを読みながらやってみてください。手戻りが怖くなくなるなど、とっても有益です。

//footnote[wakabagit][改訂2版 わかばちゃんと学ぶ Git使い方入門 @<href>{https://www.amazon.co.jp/gp/product/B096TH798S/, https://www.amazon.co.jp/gp/product/B096TH798S/}]
