...
特定部分以外は形になっている状態を作り上げることで、システム全体として問題ないのか、改善すべきところはどこか、といった観点で再設計、改善仕様提案が可能となります。多少効率の悪い/速度に難があるようなアルゴリズムで組んでも、実装してわかることもアあります。同様に手元にあるデバイスで一度作ってみましょう。必要十分かもしれません。足りないところがあれば、そこについて対応を取りましょう。
...
そして、イベントでフィードバックをもらい、明日からの進捗の糧としましょう。イベントに出ると、様々な人がほめてくれます。質問もたくさんくるでしょう。実装のヒント、改善のヒントがもらえるかもしれません。またコミュニティ、界隈との繋がりのきっかけになることもあります。
