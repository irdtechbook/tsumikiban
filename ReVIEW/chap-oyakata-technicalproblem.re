...
システムとして作り上げるためには、センサ、表示器、リレーなど、負荷（アクチュエータなど）、通信やネットワークという風に構成要素はどんどん増えていきます。そして、失敗する確率は文字通り「加速度的に」増加していきます。ミスが1箇所ならまだよいですが、2つ以上のミスが同時に発生すると、解析の難しさは飛躍的にUPします。

====[column] 要素が増えた時の切り札　モジュール化
