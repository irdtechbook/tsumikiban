...
ふりかえりの手法については深入りしませんが、興味があればふりかえりの手法について本@<fn>{furikaeribook}を読んでみるのもいいかもしれません。

//footnote[furikaeribook][ふりかえり実践会　@<href>{https://hurikaeri.booth.pm/, https://hurikaeri.booth.pm/}　や　アジャイルなチームをつくる ふりかえりガイドブック 始め方・ふりかえりの型・手法・マインドセット @<href>{https://www.amazon.co.jp/exec/obidos/ASIN/4798168793/, https://www.amazon.co.jp/exec/obidos/ASIN/4798168793/} などが参考になるかもしれません。]
...
最近、「やってみた」的な根拠のない「技術記事」が検索結果を汚染しているという指摘もありました。そういう側面も否定はできませんが、裾野が広くないと、技術の頂は高くなりません。また、そういう記事に助けられる人もいるでしょう。ですので、あまり気にしなくてかまいません。
...
ポジティブなコメントは取り入れ、改善アドバイスなども参考にすればよいでしょう。なお、万一ネガティブなフィードバックが来たら、そのときは無視してOKです。何かをやっている人はそれだけで正義です。外野の野次を気にする必要はありません。ミュートでもブロックでも何でもしちゃいましょう。マサカリ@<fn>{masakari}も基本無視でかまいません。

//footnote[masakari][経験者、知識のある人から飛んでくる鋭い指摘をマサカリと呼ぶことがあります。ただし、本当にすごい人はめったにマサカリを飛ばしたりしないもの。たいていの場合、聞きかじった人とかがとばしてくるものなので、ちょっと参考にする程度にしてもよいですが、真に受けてもしかたありません。]
...
さて、あまりにばらばらとやったことを書き連ねていては、結局どうなったかがわかりづらくなってしまう、ブログの見通しが悪くなるといった懸念が生じるでしょう。そういうときは、たとえば「やったこと」「できたこと」というふたつのタグを使って整理することができます。日々やったこと、試行錯誤の記録はやったことのカテゴリに入れ、とにかくいろいろな内容を書き出していきます。繰り返しになりますが、体系立っている必要はありません。困ったこと、やったことを丁寧に書きましょう。


「やったこと」カテゴリの記事がいくつかたまったら、これを整理して、「できたこと」タグをつけた記事を作ります。記事の本数を基準にするのもよいですが、（ある部分の）製作に一区切りがついたら、あるいは期間（たとえば1週間、1か月、1プロジェクト）で区切ってもよいでしょう。いずれにせよ、試行錯誤の結果を整理して、どういう進捗があったのかを整理・体系化します。体系化の粒度は都度調整すればよいですが、たとえば液晶モジュールを使うためにいろいろやったこと、そして結果こうしたら動いた、といった粒度を例示することができます。


「やったこと」の記事数本を、「できたこと」記事にまとめることで、記載内容は大幅に洗練・体系化されるでしょう。もちろん困ったことがあればその記事へのリンクを張るとか、その中身を参照するといったこともできます。概要を知りたい人、とりあえずやってみたいと思った人はその「できたこと」記事を読めばよいのです。そして何か躓いたら、参照をたどって「やったこと」へ移動し、解決することができるかもしれませんね。


全体として、手軽に体系化することができるという意味では、とても素敵な選択です。ただし、フィードバックをもらいづらい方法です。ある程度記事がたまるなどするまでは、手ごたえのなさに絶望するかもしれません。
...
さて、そのネタ元をブログから持ってくるのは非常にいい選択です。せっかく苦労したのに、細かい経緯を忘れてしまう、参照した別のブログが見つからない、2回目以降は自動的にできてしまうのでトピックスとしても残らない、などなど。思い出しながら登壇内容を組み立てるのは非常に大変ですが、もとになるブログがあると、それの再構築で組み立てることができますし、必要に応じて試行錯誤や細かいところまで取り出すことも容易です。また、TwitterのIDも資料に載せておくとフォローしてもらいやすくなるでしょう。


電子工作などの「現物」があるものなら、MFT(Maker Faire Tokyo)@<fn>{mft}やそのほかのMaker系イベントで展示をしてみるというのもいいですね。現物をみんなが見て、質問したり設計を説明したりするのはとても楽しいものです。

//footnote[mft][Maker Faire Tokyo @<href>{https://makezine.jp/, https://makezine.jp/}]


LT会などで話すという点は、人前で話すという（心理的な）ハードルの高さはあるものの、ダイレクトにフィードバックをもらう方法としては、かなり上位になります。やってみたレベルで構いませんので、カジュアルに話してみてください。必ずポジティブな反応がかえってきます。
...
本書を読んでいるということは、技術同人誌について改めて説明するまでもないかもしれませんが、技術的なトピックスを扱う同人誌です。技書博@<fn>{gishohaku}や技術書典@<fn>{techbookfest}やコミケ@<fn>{comike}などのイベント、Booth@<fn>{booth}などのオンラインマーケット、とらのあななどの同人誌取扱ショップなどで入手することができます。
...
//footnote[booth][Booth @<href>{https://booth.pm/ja/search/技術同人誌, https://booth.pm/ja/search/技術同人誌}]

//footnote[comike][コミックマーケット。世界最大の同人誌即売会。評論情報などのジャンルの中に、電子工作やIT技術、その他の技術情報を扱う同人誌があります。]


50ページから100ページくらいの本が多いでしょうか。筆者の推すニッチで尖った内容が盛りだくさんの本です。本そのものの作り方、頒布の仕方は、本を作ってイベントで販売するところまですべてをカバーするための本@<fn>{onestoptechbook}を参照いただくとして、作りたいもの、作ったもの、困ったこと、その解決法などを「本」という形で整理するものです。

//footnote[onestoptechbook][技術同人誌を書こう！　アウトプットのススメ (技術の泉シリーズ（NextPublishing）) 親方Project @<href>{https://www.amazon.co.jp/dp/B07BY9YWCN/, https://www.amazon.co.jp/dp/B07BY9YWCN/}]


ブログやLT・講演と異なり、任意の内容を任意の粒度で整理することができます。LTのように、時間制約のためにトピックスを端折る必要もありません。また、ブログより目次や章構成を自由かつ整理してつけることができます。


同人誌のメリットのひとつは、読者の手元に本として残ります。必要に応じて見返したりもできますね。もちろん自分であとから参照しても構いません。「よくぞこのポイントを記録しておいた！自分天才！」と思うなんていうのも、割とよくある話です。


また、ブログやLT会でのアウトプットと比較して、ひとつ大きく決定的に異なる部分があります。それは、その情報でお金を稼ぐことができる可能性があるという点です。50ページの同人誌を100部ないしは200部作ったとしましょう。500円～1000円で売ると、5万円～10万、あるいは20万円の売り上げになります。印刷費やイベント参加費などはかかりますが、数万円のお小遣いが手に入る可能性があります。そのお小遣いで、新しい基板やセンサ、部品や機器を購入しましょう。オシロとか。ブログのアフィリエイトでマネタイズするという方法もありますが、よほど確実で実入りは大きいですね。


このときにも、ブログやLTの内容を下地にするというのはよい選択です。同じ話なので繰り返しませんが。
