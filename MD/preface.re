...
積み基板とはなんでしょう？本書では、何となく/とりあえず買った、あるいは何かを作ろうと思ったけど挫折した基板たちを指します。家に1枚や2枚、あるいはもっと、そういった基板が転がってたりしませんか？
...
ソフトウエア開発の界隈では広く市民権を得てきたアジャイル開発の方法論を一部取り入れてみる、作りたいものを定義する、知っておくべきことは知っておく、電子工作における基礎知識、作例に触れてみる、様々なノウハウが集まりました。一方で、具体的な環境、特定のボードに関する記述はほとんどありません。回路図やコードに関する記述もほとんどありません。そういった内容は、本書のスコープ外です。他に素晴らしい本がたくさんありますので、そちらを参照ください。

あなたのおうちの積み基板たちに、再度注目してみてください。これをきっかけとして、何か新しいモノづくりを始める方がいると幸いです。

寄稿いただきました著者の皆様ありがとうございます。おかげで入門書としても素敵な本ができました。積み基板というキーワードに刺さる皆様からの寄稿でした。改めてお礼申し上げます。

表紙は湊川あい@llminatollさんに今回もお願いしました。ちょっと渋い顔をしつつ、積み基板に囲まれたワンストップくんちゃんです。この本が書きあがった暁にはきっと晴れ晴れした顔になることでしょう。
